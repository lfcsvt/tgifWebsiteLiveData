...
//        .then(response => response.json())
//        .then(response => {
//         senData = response.results[0].members
//         createOriginalTable(response.results[0].members),
//             createSelect(response.results[0].members)
////         checkMyCh(response.results[0].members)
//
//        
//        console.log(senData)
//    })
